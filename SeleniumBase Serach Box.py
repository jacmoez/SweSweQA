...
class TestReno(BaseCase):
    def test_main(self):
        ...
        time.sleep(2)
        self.click(style_path)
        self.click("//*[text()='Country']")
        time.sleep(2)
        self.click(style_path)
        self.click("//*[text()='English']")
        time.sleep(2)
        self.scroll_to(".custom-react-select__control.css-1xjxcct-control")
        time.sleep(2)
        self.click("/html/body/div/div/main/section[1]/div[2]/div/form/div[2]/div[2]/fieldset/div/div/div")
        self.click("//*[text()='S$60,000 - S$100,000']")
        time.sleep(2)
        self.click("/html/body/div/div/main/section[1]/div[2]/div/form/button")
        time.sleep(2)
        result = self.get_text("/html/body/div/div/main/section[2]/section/div/h6")
        print(result)
        time.sleep(2)
        self.click("/html/body/div/div/main/section[2]/section/div/div[1]/div/div/div[7]")
        time.sleep(10)